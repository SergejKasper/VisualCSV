...
<md-table-card>
    ...
    <md-table @sort="sortBy">
        ...
        <md-table-body>
            <md-table-row v-for="entry in filteredData">
                ...
                <md-table-cell>
                    <md-button v-for="c2a in buttonOptions" class="md-icon-button" v-on:click.native="c2a.fn(entry)">
                        <md-icon>{{c2a.name}}</md-icon>
                    </md-button>
                </md-table-cell>
            </md-table-row>
        </md-table-body>
    ...
    <md-bottom-bar>
        <md-bottom-bar-item md-icon="add" v-on:click.native="columnOptions.addRow()" md-active>Neue Zeile hinzufügen</md-bottom-bar-item>
    </md-bottom-bar>
</md-table-card>
